...
class ReaddirBatch extends Batch<Buffer[] | fs.Dirent[] | string[], { path: fs.PathLike; options: EncodingOptions }> {
  public constructor(private readonly proxy: FsModuleProxy) {
    super()
  }

  protected remoteCall(
    queue: { path: fs.PathLike; options: EncodingOptions }[]
...
export class FsModule {
  ...
  public access = (
    path: fs.PathLike,
    mode: number | undefined | ((err: NodeJS.ErrnoException) => void),
  ...
  public appendFile = (
    ...
    data: any,
    options?: fs.WriteFileOptions | ((err: NodeJS.ErrnoException) => void),
    callback?: (err: NodeJS.ErrnoException) => void
  ): void => {
  ...
  public copyFile = (
    src: fs.PathLike,
    dest: fs.PathLike,
    flags: number | ((err: NodeJS.ErrnoException) => void),
    callback?: (err: NodeJS.ErrnoException) => void
  ): void => {
    if (typeof flags === "function") {
      callback = flags
    }
    callbackify(this.proxy.copyFile)(src, dest, typeof flags !== "function" ? flags : undefined, callback!)
  }
  ...
  public ftruncate = (
    fd: number,
    len: number | undefined | null | ((err: NodeJS.ErrnoException) => void),
    callback?: (err: NodeJS.ErrnoException) => void
  ): void => {
  ...
  public mkdir = (
    path: fs.PathLike,
    mode: number | string | fs.MakeDirectoryOptions | undefined | null | ((err: NodeJS.ErrnoException) => void),
    callback?: (err: NodeJS.ErrnoException) => void
  ): void => {
    if (typeof mode === "function") {
      callback = mode
  ...
  public open = (
    path: fs.PathLike,
    flags: string | number,
    mode: string | number | undefined | null | ((err: NodeJS.ErrnoException | null, fd: number) => void),
  ...
  public symlink = (
    target: fs.PathLike,
    path: fs.PathLike,
    type: fs.symlink.Type | undefined | null | ((err: NodeJS.ErrnoException) => void),
    callback?: (err: NodeJS.ErrnoException) => void
  ): void => {
  ...
  public write = (
    fd: number,
    buffer: Buffer,
    offset: number | undefined | ((err: NodeJS.ErrnoException, written: number, buffer: Buffer) => void),
    length: number | undefined | ((err: NodeJS.ErrnoException, written: number, buffer: Buffer) => void),
    position: number | undefined | ((err: NodeJS.ErrnoException, written: number, buffer: Buffer) => void),
  ...
  public watch = (
    ...
    options?: EncodingOptions | ((event: string, filename: string | Buffer) => void),
