...
export class Socket extends Duplex<ClientNetSocketProxy> implements net.Socket {
  ...
  public connect(
    options: number | string | net.SocketConnectOpts,
...
export class Server extends ClientProxy<ClientNetServerProxy> implements net.Server {
  ...
  public listen(
    handle?: net.ListenOptions | number | string,
    hostname?: string | number | Function,
    backlog?: number | Function,
    callback?: Function
  ): this {
...
export class NetModule implements NodeNet {
  ...
  public createConnection = (
    target: string | number | net.NetConnectOpts,
    host?: string | Function,
    callback?: Function
  ): net.Socket => {
    if (typeof host === "function") {
